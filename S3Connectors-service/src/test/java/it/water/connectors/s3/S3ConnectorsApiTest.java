...
import it.water.connectors.s3.service.S3ConnectorsSystemServiceImpl;
 ...
 * Test class for S3Connectors Services.
...
class S3ConnectorsApiTest implements Service {
    private S3ConnectorsSystemServiceImpl service;
    ...
    void setup() {
        ...
        service = S3ConnectorsSystemServiceImpl.connect(config);
