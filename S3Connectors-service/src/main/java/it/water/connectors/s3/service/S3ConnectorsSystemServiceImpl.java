...
import it.water.connectors.s3.api.S3ConnectorsSystemApi;
 ...
 * System Service Api Class for S3Connectors entity.
 *
 */
@Setter
@FrameworkComponent
public class S3ConnectorsSystemServiceImpl extends BaseSystemServiceImpl implements S3ConnectorsSystemApi {
    ...
    private void configure(S3ClientConfig config) {
    ...
    public static S3ConnectorsSystemServiceImpl connect(S3ClientConfig config) {
        config.validate();
        S3ConnectorsSystemServiceImpl instance = new S3ConnectorsSystemServiceImpl();
